  ...
  (
    ...
    return (
      <button
        ...
        title={label}
        className={cx(
          "flex cursor-pointer items-center justify-center rounded p-2 text-font",
...
export interface Props extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  /** The icon element to render inside the button (e.g. a react-icons component) */
  icon: React.ReactNode;
  /** Accessible label for the button (used as aria-label and title tooltip) */
  label: string;
