  ...
  return (
    <div className="w-[400px]">
      <Link
        to={project.id}
        className={cx(
          "group flex h-[112px] rounded text-font shadow-sm outline outline-2 outline-transparent duration-100 ease-linear",
          "hover:-translate-y-0.5 hover:text-font-brand hover:shadow-md hover:outline-border-brand"
        )}
        style={{ backgroundColor: "var(--Red700)" }}
      >
        <img
        ...
        <div className="flex flex-col gap-1 px-3 pb-4 pt-2">
          <h2 className="text-lg text-font-subtle">{project.name}</h2>
