...
export const Header = (): JSX.Element => {
  ...
  return (
    <header className="relative z-10 flex w-full items-center justify-between px-5 py-2 shadow-[0_1px_5px_-1px_rgba(0,0,0,0.3)]" style={{ backgroundColor: '#ffffff' }}>
      <section>
        <Link
          to="/"
        ...
        >
          <span className="font-primary-black text-xl" style={{ color: '#ff0000' }}>Fei</span>
        </Link>
      </section>
