...
export const LoginView = ({ users }: Props) => {
  ...
  return (
    <div className="mx-auto max-w-[400px] pt-[10vh] flex flex-col" style={{ color: 'var(--Red700)' }}>
      <h1 className="font-primary-black text-5xl" style={{ color: 'var(--Red700)' }}>
        Select login user
      </h1>
      <h2 className="mb-8 mt-3 font-primary-light text-lg" style={{ color: 'var(--Red700)' }}>
