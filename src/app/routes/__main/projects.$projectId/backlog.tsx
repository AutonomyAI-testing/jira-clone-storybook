...
import { BacklogView } from "@app/ui/main/project/board/backlog";
...
export const meta: V2_MetaFunction<typeof loader> = ({ data }) => {
  ...
  const description =
    "Manage your project backlog. View and organize all issues.";
...
export const action: ActionFunction = async ({ request }) => {
  ...
  return json({ error: `Unknown action: ${_action}` }, { status: 400 });
};
